  ...
  return (
    ...
    >
      <div className='text-center'>
        ...
        <h2 className='text-xl mt-4 -mb-48 text-white md:text-4xl md:p-6 lg:text-5xl lg:-mb-96 xl:-mt-4 '>
          GAME ECONOMY DESIGN
        </h2>
      </div>
      <p className='text-white text-center font-mont p-8 mt-12 md:text-3xl md:mt-48 md:p-10 lg:text-4xl lg:p-16 lg:-mt-28 xl:text-3xl xl:mt-8 xxl:-mt-6'>
      ...
      <div className='relative space-y-8 text-center mb-32 -mt-4 md:mb-[200px] md:mt-12 lg:mb-[100px] lg:-mt-96 xxl:-mb-20'>
        <button className='bg-bubble text-center shadow-xl text-white text-lg px-4 py-2 mb-20 md:text-xl md:px-8 md:py-3 lg:px-12 lg:py-4 lg:text-3xl xl:hidden xxl:hidden'>
          LET'S TALK
        </button>
        <img
