...
const Main = () => {
  return (
    <div className='w-screen h-screen grid grid-rows-[auto,1fr,auto] bg-pink items-center justify-items-center p-5'>
      {/* Header */}
      <header className='text-center space-y-4 md:mt-10 lg:mt-20 xl:mt-20'>
        ...
        <h2 className='text-xl text-white md:text-3xl lg:text-4xl xl:text-4xl xxl:text-5xl'>
          GAME ECONOMY DESIGN
        </h2>
      </header>
      ...
      <main className='text-white text-center text-md space-y-4 p-5'>
        <p className='-mt-12 md:text-xl lg:text-3xl xl:text-2xl xxl:text-3xl xxl:mt-6'>
      ...
      {/* Footer */}
      <footer className='text-center space-y-20 mb-12 xxl:mb-10'>
